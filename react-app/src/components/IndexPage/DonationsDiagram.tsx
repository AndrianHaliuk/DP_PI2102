      ...
      <div className="container">
        <div className="diagram-section-wrapper">
          ...
          <p className="diagram-paragraph">
            Ми глибоко усвідомлюємо, що кожна пожертва є виявом довіри, тому кожен донор має право знати, як саме використовуються надані кошти. Наша організація зобов’язується дотримуватися принципів прозорості та відкритості, забезпечуючи чіткий облік надходжень і звітність щодо напрямків їх використання.
          </p>
        </div>
